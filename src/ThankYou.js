...
class ThankYou extends Component {
    constructor(props) {
        super();
        this.order = {
            address: props.location.state.shippingForm,
            shippingCost: props.location.state.shippingCost,
                        ...
                        <div className='details-wrapper'>
                            <div className='detail-row'>
                                ...
                                <div className='detail-item inline'>
                                    <address>
                                        {this.order.address.streetAddress}
                                        <br />
                                        {this.order.address.city}, {this.order.address.state} {this.order.address.zipCode}
                                    </address>
                                </div>
                            </div>
                            <div className='detail-row'>
